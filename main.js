...
var fc = AdresBuk.findContact('tek');
console.log(fc);
var fc1 = AdresBuk.findContact('wal');
console.log(fc1);
var Person2 = new Contact_1.Contact("Genowefa", "Pigwa", "g.pigwa@gmail.com");
Grupa.addContactToGroup(Person2);
AdresBuk.allGroups.forEach(function (a) { return a.contactList.forEach(function (b) { return console.log(b.lastName); }); });
